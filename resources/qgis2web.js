...
var map = new ol.Map({
    controls: ol.control.defaults({attribution:false}).extend([
        expandedAttribution, new measureControl(), scaleLineControl, new ol.control.FullScreen()
    ]),
...
map.getView().fit([-8366145.458693, -4412075.702150, -7000898.487287, -3624373.682576], map.getSize());
